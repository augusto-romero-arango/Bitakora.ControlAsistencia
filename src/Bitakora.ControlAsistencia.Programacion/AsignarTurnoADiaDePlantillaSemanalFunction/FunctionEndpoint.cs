...
// PUT reemplaza completo un VO atomico direccionable -- el turno del dia (MEF-ADR-0043 paso 2).
// El slot (semana, dia) existe por construccion (7 x N slots, CA-ADR-0034), asi que este PUT nunca
// "crea": responde 204 No Content, tambien cuando el turno ya era el mismo (SinCambios) -- nunca
// AcceptedResult, a diferencia del resto de comandos de este dominio.
// Los tres componentes de ruta se validan ANTES de despachar (MEF-ADR-0004 capa 1): un {dia} fuera
// de 1..7 sale 400 sin que el router llegue a invocarse.
