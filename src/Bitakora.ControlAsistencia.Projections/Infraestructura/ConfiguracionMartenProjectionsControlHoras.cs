...
/// el mismo schema "control_horas" que ya usa el write-side
/// (ComposicionServicios.AgregarServiciosControlHoras), replicando la configuracion de
        ...
        services.AddMartenStore<IControlHorasProjectionStore>(opts =>
            {
                ...
                opts.DatabaseSchemaName = "control_horas"; // mismo schema que el write-side (MEF-ADR-0003)
