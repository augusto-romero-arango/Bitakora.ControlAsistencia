...
public partial class QuitarSubFranjaTool
{
    private static readonly ResourceManager ResourceManager = new(
        "Bitakora.ControlAsistencia.Mcp.Comandos.QuitarSubFranja.QuitarSubFranjaToolMensajes",
        typeof(QuitarSubFranjaTool).Assembly);
    ...
    internal static class Mensajes
    {
        ...
        /// <summary>{0}: nombre del campo (franja/inicio); {1}: valor recibido.</summary>
        ...
        public static string ResultadoSubFranjaQuitada =>
            ResourceManager.GetString(nameof(ResultadoSubFranjaQuitada))!;
