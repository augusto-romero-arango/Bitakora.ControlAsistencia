...
public partial class AgregarFranjaTool
{
    private static readonly ResourceManager ResourceManager = new(
        "Bitakora.ControlAsistencia.Mcp.Comandos.AgregarFranja.AgregarFranjaToolMensajes",
        typeof(AgregarFranjaTool).Assembly);
    ...
    internal static class Mensajes
    {
        ...
        /// <summary>{0}: nombre del campo (inicio/fin); {1}: valor recibido.</summary>
        ...
        public static string ResultadoFranjaAgregada =>
            ResourceManager.GetString(nameof(ResultadoFranjaAgregada))!;
