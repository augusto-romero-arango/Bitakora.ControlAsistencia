...
// (MEF-ADR-0043 paso 4) -- POST "{recurso}:{verbo}", nunca PUT sobre una bandera. Exito sin
// representacion -> 204. Sin body, asi que no hay IRequestValidator: el {codigo} de ruta es lo
// unico que validar (MEF-ADR-0037 seccion 2).
