# ADR-0024: Heuristicas de evolucion y reuso del codigo
...
ADR-0015 abrio el patron de "ADR como tabla de heuristicas con disclaimer de
...
- **Naming, estructura de carpetas u otros ejes de evolucion**. Si esas
  heuristicas crecen, merecen su propio ADR (igual que ADR-0015 se mantuvo
...
- ADR-0015 (Heuristicas de modelado de objetos de dominio) -- precedente del
