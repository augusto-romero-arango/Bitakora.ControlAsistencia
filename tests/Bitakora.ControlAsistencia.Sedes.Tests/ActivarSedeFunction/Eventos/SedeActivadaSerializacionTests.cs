...
namespace Bitakora.ControlAsistencia.Sedes.Tests.ActivarSedeFunction.Eventos;

public class SedeActivadaSerializacionTests
{
    ...
    public void RoundTrip_ReconstruyeEvento_SinPayload()
    {
        ...
        var restaurado = JsonSerializer.Deserialize<SedeActivada>(json, opciones);
