// Issue #456 (gemela exacta de AssertsIdentidadEventos de Colaboradores.Tests/ControlHoras.Tests/
// Programacion.Tests): detecta un evento persistido que quedo fuera del registro explicito de
// IdentidadEventosSedes.TiposPersistidos. Sin AddEventTypes, la primera rehidratacion de un stream
// con datos preexistentes cae al fallback por mt_dotnet_type y revienta con
...
public static class AssertsIdentidadEventos
{
    ...
    /// AliasEventosSedesTests ya lo congela sobre un StoreOptions standalone, pero ahi no vive el
    /// wiring: un MapEventType o un EventNamingStyle introducidos en ComposicionServicios cambiarian
    /// la identidad de eventos ya persistidos sin poner rojo ningun otro test.
    /// </summary>
