// Contrato de igualdad de DetalleColaborador, por simetria con la familia Detalle*IgualdadTests.
...
public class DetalleColaboradorIgualdadTests : IgualdadTestBase<DetalleColaborador>
{
    protected override DetalleColaborador CrearInstancia() =>
        new("EMP-001", "CC", "1234567890", "Luis Augusto", "Barreto");

    protected override DetalleColaborador CrearInstanciaCopia() =>
        new("EMP-001", "CC", "1234567890", "Luis Augusto", "Barreto");
    ...
    protected override IEnumerable<(string, DetalleColaborador)> CrearInstanciasDiferentes()
    {
        ...
        yield return ("NumeroIdentificacion",
            new DetalleColaborador("EMP-001", "CC", "9999999999", "Luis Augusto", "Barreto"));
        yield return ("Nombres",
            new DetalleColaborador("EMP-001", "CC", "1234567890", "Otro Nombre", "Barreto"));
        yield return ("Apellidos",
            new DetalleColaborador("EMP-001", "CC", "1234567890", "Luis Augusto", "Otro Apellido"));
    }
}
