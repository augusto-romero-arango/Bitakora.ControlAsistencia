...
namespace Bitakora.ControlAsistencia.Mcp.Consultas.SmokeTests.Handshake;
...
public class HandshakeSmokeTests(McpFixture mcp)
{
    ...
    // con el serverName de host.json prueba que el host cargo la extension MCP y NUESTRO host.json,
    // no un default.
    [Fact]
    ...
    public async Task ServidorMcp_ReportaSuIdentidad_CuandoCompletaElHandshake()
    {
        ...
        mcp.Cliente.ServerInfo.Name.Should().Be("ControlAsistencias Consultas");
    }
}
